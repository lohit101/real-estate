...
const priceRanges = [
    { label: "40 Lacs - 1 Cr", value: [4000000, 10000000] },
                ...
                <button onClick={() => {
                    if (!category) {
                        toast('No Category Selected', {
                            description: "Please select a property category to search for properties.",
                        });
                        return;
                    }
                    setLoading(true)
                    ...
                    type="submit"
                    className="flex items-center justify-center h-max sm:h-full w-full sm:w-max sm:aspect-square bg-black text-white font-semibold p-3 sm:p-0 shadow-sm hover:bg-black/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-all duration-500 disabled:bg-zinc-800"
                >
                    {/* Button for desktop */}
